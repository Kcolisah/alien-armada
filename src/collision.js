...
function hitTestCircle(c1, c2)
{
  ...
  let vx = c1.centerX() - c2.centerX();
  let vy = c1.centerY() - c2.centerY();
...
{  
  ...
  let combinedHalfWidths = c1.halfWidth() + c2.halfWidth();
  ...
  if(magnitude < combinedHalfWidths)
  {
    ...
    let overlap = combinedHalfWidths - magnitude;
